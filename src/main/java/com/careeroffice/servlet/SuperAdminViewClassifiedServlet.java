...
@WebServlet({"/view_classified"})
public class SuperAdminViewClassifiedServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("WEB-INF/views/super_admin/view_classified.jsp").forward(request, response);
    }
}