...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="adminclassifieds?id=${classified.id}&action=update" method="POST">
                    ...
                    <br />
                    <a href="adminclassifieds" class="btn btn-warning"><i class="fas fa-caret-left" style="margin-right:8px"></i>Cancel</a>
