...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="admin">Edit</a></li>
        </ol>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form method="post" action="admin?action=update" id="edit_admin_form">
            ...
            <div class="card-footer flex-row align-items-center text-right">
                <a href="admin" class="btn btn-warning"><i class="fas fa-caret-left" style="margin-right:8px"></i>Cancel</a>
                <button type="submit" class="btn btn-success" form="edit_admin_form"><i class="far fa-save" style="margin-right:8px"></i>Update</button>
            </div>
        </div>
    </div>
