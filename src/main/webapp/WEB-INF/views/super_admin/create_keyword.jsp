...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="<c:url value="/create_keyword"/>" method="POST" id="create_keyword_form">
                    <div class="form-row">
            ...
            <div class="card-footer d-flex flex-row align-items-center justify-content-end">
                <button class="btn btn-primary d-flex flex-row align-items-center mr-3" form="create_keyword_form">
